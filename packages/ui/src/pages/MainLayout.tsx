    ...
    <div className="layout">
      <header className="topbar">
        ...
        <div className="topbar-center">
          <ContextSelector
            ...
            syncState={syncState}
            syncTitle={syncState === 'checking' ? t.sync_checking
      ...
      <div className="main">
        <nav className={`sidebar ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
          <SidebarLink to="/" end label={t.nav_overview} collapsed={sidebarCollapsed}>
          ...
          <SidebarLink to="/repositories" label={t.nav_repositories} collapsed={sidebarCollapsed}>
          ...
          <SidebarLink to="/mcps" label={t.nav_mcps} collapsed={sidebarCollapsed}>
          ...
          <SidebarLink to="/contexts" label={t.nav_contexts_res} collapsed={sidebarCollapsed}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>
            <span>{t.nav_contexts_res}</span>
          </SidebarLink>

          <p className="nav-group">{t.nav_group_final}</p>
          <SidebarLink to="/summary" label={t.nav_summary} collapsed={sidebarCollapsed}>

...
interface Props { type: string; file: string; title: string; version?: string; onClose: () => void }
        ...
        <div className="modal-body">
          <div className="file-content-wrapped">
            {loading
              ...
              : <div className="file-content-md" dangerouslySetInnerHTML={{ __html: marked.parse(content) as string }} />
            }
          </div>
        </div>
